...
#define BLE_LINK_STATE_PROTOCOL_MAJOR DEVICE_LINK_CORE_MAJOR
#define BLE_LINK_STATE_PROTOCOL_MINOR DEVICE_LINK_CORE_MINOR
#define BLE_LINK_STATE_PROFILE_MAJOR DEVICE_LINK_PROFILE_MAJOR
#define BLE_LINK_STATE_PROFILE_MINOR DEVICE_LINK_PROFILE_MINOR
